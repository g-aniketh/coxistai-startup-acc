 ...
 */
export async function getExceptionReports(startupId: string, asOnDate?: string) {
  ...
  for (const ledger of ledgers) {
    ...
    const hasOpeningBalance = ledger.openingBalance !== null && Number(ledger.openingBalance) !== 0;
