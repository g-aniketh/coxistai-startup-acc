...
router.get('/categories', async (req: AuthRequest, res: Response) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to fetch cost categories',
    });
  }
});
...
router.post('/categories', async (req: AuthRequest, res: Response) => {
  try {
    ...
    return res.status(400).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to create cost category',
    });
  }
});
...
router.put('/categories/:categoryId', async (req: AuthRequest, res: Response) => {
  try {
    ...
    const category = await updateCostCategory(startupId, req.params.categoryId, req.body);
    return res.json({
      success: true,
      data: category,
    ...
    return res.status(400).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to update cost category',
    });
  }
});
...
router.delete('/categories/:categoryId', async (req: AuthRequest, res: Response) => {
  try {
    ...
    return res.status(400).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to delete cost category',
    });
  }
});
...
router.post('/centers', async (req: AuthRequest, res: Response) => {
  try {
    ...
    return res.status(400).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to create cost center',
    });
  }
});
...
router.put('/centers/:centerId', async (req: AuthRequest, res: Response) => {
  try {
    ...
    const center = await updateCostCenter(startupId, req.params.centerId, req.body);
    return res.json({
      success: true,
      data: center,
...
router.delete('/centers/:centerId', async (req: AuthRequest, res: Response) => {
  try {
    ...
    return res.status(400).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to delete cost center',
    });
  }
});
...
router.get('/interest-profiles', async (req: AuthRequest, res: Response) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to fetch interest profiles',
    });
  }
});
...
router.post('/interest-profiles', async (req: AuthRequest, res: Response) => {
  try {
    ...
    return res.status(400).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to create interest profile',
    });
  }
});

router.put('/interest-profiles/:profileId', async (req: AuthRequest, res: Response) => {
  try {
    const startupId = req.user?.startupId;
    if (!startupId) {
      return res.status(400).json({ success: false, message: 'Startup context is required' });
    ...
    const profile = await updateInterestProfile(startupId, req.params.profileId, req.body);
    return res.json({
      success: true,
      data: profile,
    ...
    return res.status(400).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to update interest profile',
    });
  }
});

router.delete('/interest-profiles/:profileId', async (req: AuthRequest, res: Response) => {
  try {
    const startupId = req.user?.startupId;
    if (!startupId) {
      return res.status(400).json({ success: false, message: 'Startup context is required' });
    ...
    return res.status(400).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to delete interest profile',
    });
  }
});
...
router.get('/interest-settings', async (req: AuthRequest, res: Response) => {
  try {
    ...
    return res.status(500).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to fetch party interest settings',
    });
  }
});
...
router.post('/interest-settings', async (req: AuthRequest, res: Response) => {
  try {
    ...
    return res.status(400).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to assign interest setting',
    });
  }
});

router.delete('/interest-settings/:partyId', async (req: AuthRequest, res: Response) => {
  try {
    const startupId = req.user?.startupId;
    if (!startupId) {
      return res.status(400).json({ success: false, message: 'Startup context is required' });
    ...
    return res.status(400).json({
      success: false,
      message: error instanceof Error ? error.message : 'Failed to remove interest setting',
    });
  }
});
