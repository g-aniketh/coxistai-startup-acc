...
router.get('/permissions/:permissionId', async (req: AuthRequest, res: Response) => {
  try {
...
// Update a permission
router.put('/permissions/:permissionId', async (req: AuthRequest, res: Response) => {
  try {
    const { permissionId } = req.params;
...
// Delete a permission
router.delete('/permissions/:permissionId', async (req: AuthRequest, res: Response) => {
  try {
    const { permissionId } = req.params;
...
router.delete('/users/:userId/roles/:roleId', async (req: AuthRequest, res: Response) => {
  try {
