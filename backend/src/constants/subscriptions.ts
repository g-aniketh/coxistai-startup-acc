export type SubscriptionPlanCode = 'starter_earlybird' | 'starter' | 'pro' | 'enterprise';
...
export const SUBSCRIPTION_PLAN_CATALOG: Record<SubscriptionPlanCode, SubscriptionPlanDefinition> = {
  starter_earlybird: {
...
export const DEFAULT_SUBSCRIPTION_PLAN: SubscriptionPlanCode = 'starter_earlybird';

export const getSubscriptionPlan = (code: string): SubscriptionPlanDefinition => {
