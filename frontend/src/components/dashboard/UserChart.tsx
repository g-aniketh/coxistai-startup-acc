  ...
  return (
    <Card className="rounded-2xl shadow-lg border-0 bg-white">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <div>
          <CardTitle className="text-lg font-semibold text-gray-800">User in The Last Week</CardTitle>
          <CardDescription className="text-sm text-green-600 font-semibold">+ 3,2%</CardDescription>
        </div>
