      ...
      const mockUpdates = [
        {
          ...
          executiveSummary:
            "Q4 2024 was a strong quarter for our company, with significant growth in revenue and customer acquisition. We exceeded our targets across all key metrics and are well-positioned for continued expansion in 2025.",
          highlights: [
        ...
        },
        {
          ...
          executiveSummary:
            "Q3 2024 demonstrated solid execution on our growth strategy with strong revenue performance and successful product launches. We maintained healthy unit economics while scaling our customer base.",
          highlights: [
        ...
        },
        {
          ...
          executiveSummary:
            "Q1 2025 is off to a strong start with ambitious goals for revenue growth and market expansion. We're focusing on scaling our enterprise sales and launching new AI-powered features.",
          highlights: [
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700">
                        AI-powered report generation • Live data integration
                      </p>
                    </div>
                  </div>
                ...
                <Card className="rounded-xl border-0 shadow-lg">
                  <CardContent className="p-12 text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                      Generate AI-powered updates to keep your investors
                      informed
                    </p>
                    <Button
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 text-sm text-gray-600">
                              ...
                              <Badge
                                variant={update.isDraft ? "outline" : "default"}
                                className={
                                  update.isDraft
                          ...
                          <Button
                            onClick={() =>
                              setSelectedUpdate(
                                selectedUpdate?.id === update.id ? null : update
                              )
                            }
                            variant="outline"
                            size="sm"
                          ...
                          <div className="grid grid-cols-2 gap-3 mb-4">
                            <div className="p-3 rounded-lg bg-[#C9E0B0]">
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                <span className="text-xs text-[#3a5129]">
                                  Revenue
                                </span>
                              </div>
                            ...
                            <div className="p-3 rounded-lg bg-[#F6D97A]">
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                <span className="text-xs text-[#7a6015]">
                                  MRR
                                </span>
                              </div>
                              <div className="text-lg font-bold text-[#2C2C2C]">
