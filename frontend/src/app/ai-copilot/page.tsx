  ...
  const runScenario = async () => {
    ...
    try {
      ...
      const mockResult = {
        ...
        analysis:
          "This scenario would significantly impact your runway. The increased burn rate from hiring would reduce your runway by 1.4 months. Consider the timing carefully and ensure you have sufficient funding runway.",
        recommendations: [
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700">
                        Advanced financial analysis • Scenario modeling •
                        Strategic insights
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-purple-700">
                            Get personalized financial recommendations based on
                            your data
                          </p>
                        </div>
                        <Button
                            ...
                            {insights.recommendations.map(
                              (rec: AIRecommendation, index: number) => (
                                ...
                                >
                                  ...
                                  <p className="text-sm font-medium text-[#607c47]">
                                    {rec.impact}
                                  </p>
                                </div>
                              )
                      ...
                      <CardContent className="pt-0 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div className="bg-blue-50 rounded-lg p-4">
                            ...
                            <div className="text-xs text-blue-600">
                              {scenarioResult.impact.runway.change > 0
                                ? "+"
                                : ""}
                              {scenarioResult.impact.runway.change} mo
                            </div>
                          </div>
                          ...
                          <div className="bg-red-50 rounded-lg p-4">
                            ...
                            <div className="text-lg font-bold text-red-900">
                              {formatCurrency(
                                scenarioResult.impact.burnRate.new
                              )}
                            </div>
                            <div className="text-xs text-red-600">
                              {scenarioResult.impact.burnRate.change > 0
                                ? "+"
                                : ""}
                              {scenarioResult.impact.burnRate.change}%
                            </div>
                          </div>
                          ...
                          <div className="bg-green-50 rounded-lg p-4">
                            ...
                            <div className="text-lg font-bold text-green-900">
                              {formatCurrency(
                                scenarioResult.impact.cashFlow.new
                              )}
                            </div>
                            <div className="text-xs text-green-600">
                              {scenarioResult.impact.cashFlow.change > 0
                                ? "+"
                                : ""}
                              {scenarioResult.impact.cashFlow.change}%
                            </div>
                          </div>
                        </div>
                        ...
                        <div
                          className={`rounded-lg p-4 ${
                            scenarioResult.riskLevel === "High"
                              ? "bg-red-50 border border-red-200"
                              : scenarioResult.riskLevel === "Medium"
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-semibold text-[#2C2C2C]">
                              Risk Level: {scenarioResult.riskLevel}
                            </span>
                          </div>
                        </div>
                      </CardContent>
