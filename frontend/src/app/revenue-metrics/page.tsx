        ...
        <MainLayout>
          <div className="p-8">
            ...
            <p className="text-muted-foreground">
              No metrics available. Connect Stripe and sync your data.
            </p>
          </div>
        </MainLayout>
      </AuthGuard>
        ...
        <div className="p-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Track your recurring revenue and growth
            </p>
          </div>
          <button
            onClick={syncData}
    ...
    // Total Revenue
    {
      ...
      content: (
        <div className="p-6">
          ...
          <div className="text-3xl font-bold text-foreground">
            <CountUp
              to={Number(metrics.totalRevenue)}
              duration={1.5}
              prefix="$"
            />
          </div>
              ...
              <div className="pt-4 border-t border-border">
                ...
                <div className="text-3xl font-bold text-primary">
                  {Number(metrics.customerAcquisitionCost) > 0
                    ? (
                        Number(metrics.lifetimeValue) /
                        Number(metrics.customerAcquisitionCost)
                      ).toFixed(2)
                    : "N/A"}
                </div>
                <p className="text-xs text-muted-foreground mt-2">
