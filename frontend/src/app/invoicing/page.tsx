...
export default function InvoicingPage() {
  ...
  useEffect(() => {
    setInvoices([
      ...
      },
      {
        ...
        status: "Paid",
        items: [
          { id: "i1", description: "Advisory", quantity: 5, unitPrice: 300 },
        ],
        notes: "Paid via ACH.",
        total: 1500,
        balanceDue: 0,
  ...
  const createInvoice = () => {
    ...
    const draft: Invoice = {
      ...
      status: "Draft",
      items: [
        { id: "i1", description: "Service", quantity: 1, unitPrice: 100 },
      ],
      notes: "",
      total: 100,
      balanceDue: 100,
      ...
      prev.map((inv) =>
        inv.id === id
          ? {
              ...
              balanceDue:
                computeTotal(inv.items) - (inv.total - inv.balanceDue),
            }
          : inv
      )
    );
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-[#2C2C2C]/70">
                    Create invoices, track payments, and send AI reminders
                  </p>
                </div>
