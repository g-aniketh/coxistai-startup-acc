...
export default function BankingPaymentsHubPage() {
  ...
  useEffect(() => {
    // Initialize bank connections from centralized constants
    setBankConnections(HOSPITAL_BANK_CONNECTIONS);
  ...
  const generateInvoicePDF = async (invoice: Invoice) => {
    try {
      ...
      pdf.text("Sai Vishwas Hospitals", 20, yPosition);
      yPosition += 10;

      pdf.setFontSize(12);
      pdf.setTextColor(107, 114, 128); // #6b7280
      pdf.text("Hospital Financial Management System", 20, yPosition);
      yPosition += 5;
      pdf.text("Sai Vishwas Hospitals", 20, yPosition);
      yPosition += 5;
      pdf.text("Hospital Address, City, State - PIN", 20, yPosition);
      yPosition += 15;
      ...
      yPosition += 5;
      pdf.text(
        "Generated by Sai Vishwas Hospitals - Hospital Financial Management System",
        pageWidth / 2,
        yPosition,
        { align: "center" }
      );
